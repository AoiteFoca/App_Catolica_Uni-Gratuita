    ...
    <View className="flex-1 bg-white p-5 mt-5">
      ...
      <View className="ml-5 mb-7">
        <TouchableOpacity className="flex-row items-center mb-5 mt-1">
          ...
          <Text className="ml-4 text-base text-stone-700">Alterar e-mail</Text>
        </TouchableOpacity>
        <TouchableOpacity className="flex-row items-center mb-5 mt-1">
      ...
      <TouchableOpacity className="flex-row items-center justify-center bg-orange-600 py-4 rounded-full">
        <Text className="text-white text-base mr-2">LOGOUT</Text>
