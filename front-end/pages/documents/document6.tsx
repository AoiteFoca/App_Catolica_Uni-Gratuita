...
type Props = NativeStackScreenProps<RootStackParamList, 'Document6'>;

const Document6: React.FC<Props> = ({ navigation }) => {
      ...
      <View style={styles.progressContainer}>
        ...
        {[...Array(5)].map((_, index) => (
          ...
          <View style={[styles.progressStep, index === 0 && styles.activeStep]}>
            <Text style={[styles.progressText, index === 0 && styles.activeProgressText]}>{index + 6}</Text>
          </View>
        </View>
        ))}
  ...
  >
    <Icon name="help-circle-outline" size={24} color="#7d0a16" />
      ...
      <View style={styles.bottomBarContainer}>
        <AppBottomBar currentTab="Document6" />
      </View>
    </View>
  );
};
